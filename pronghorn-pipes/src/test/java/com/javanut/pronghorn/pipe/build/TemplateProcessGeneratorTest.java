...
import com.javanut.pronghorn.pipe.util.build.SimpleSourceFileObject;
import com.javanut.pronghorn.pipe.util.build.TemplateProcessGeneratorLowLevelReader;
    ...
    public void testGenerateLowLevelWriterCleanCompile() {
    	...
    	if ("arm".equals(System.getProperty("os.arch"))) {
	        ...
	        try {
	            ...
	            TemplateProcessGeneratorLowLevelWriter simple = new TemplateProcessGeneratorLowLevelWriter(schema, target, true, "com.javanut.pronghorn.pipe.build");
